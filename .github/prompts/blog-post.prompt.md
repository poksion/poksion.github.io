---
description: "Create a new Jekyll blog post draft in _posts from a title"
name: "Create Blog Post"
argument-hint: "제목을 입력하세요"
agent: "agent"
---

Create a new Jekyll blog post draft in this workspace from the title provided after `/blog-post`.
...
- Create the file at `_posts/YYYY-MM-DD-slug.md`.
